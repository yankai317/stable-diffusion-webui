...
public final class SdServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<Sd.SdText2ImgRequest,
      Sd.SdText2ImgResponse> getText2imgMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "text2img",
      requestType = Sd.SdText2ImgRequest.class,
      responseType = Sd.SdText2ImgResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<Sd.SdText2ImgRequest,
      Sd.SdText2ImgResponse> getText2imgMethod() {
    io.grpc.MethodDescriptor<Sd.SdText2ImgRequest, Sd.SdText2ImgResponse> getText2imgMethod;
      ...
      synchronized (SdServiceGrpc.class) {
        if ((getText2imgMethod = SdServiceGrpc.getText2imgMethod) == null) {
          SdServiceGrpc.getText2imgMethod = getText2imgMethod =
              io.grpc.MethodDescriptor.<Sd.SdText2ImgRequest, Sd.SdText2ImgResponse>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Sd.SdText2ImgResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<Sd.SdImg2ImgRequest,
      Sd.SdImg2ImgResponse> getImg2imgMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "img2img",
      requestType = Sd.SdImg2ImgRequest.class,
      responseType = Sd.SdImg2ImgResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<Sd.SdImg2ImgRequest,
      Sd.SdImg2ImgResponse> getImg2imgMethod() {
    io.grpc.MethodDescriptor<Sd.SdImg2ImgRequest, Sd.SdImg2ImgResponse> getImg2imgMethod;
    if ((getImg2imgMethod = SdServiceGrpc.getImg2imgMethod) == null) {
      synchronized (SdServiceGrpc.class) {
        if ((getImg2imgMethod = SdServiceGrpc.getImg2imgMethod) == null) {
          SdServiceGrpc.getImg2imgMethod = getImg2imgMethod =
              io.grpc.MethodDescriptor.<Sd.SdImg2ImgRequest, Sd.SdImg2ImgResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Sd.SdImg2ImgResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    default void text2img(Sd.SdText2ImgRequest request,
        io.grpc.stub.StreamObserver<Sd.SdText2ImgResponse> responseObserver) {
    ...
    default void img2img(Sd.SdImg2ImgRequest request,
        io.grpc.stub.StreamObserver<Sd.SdImg2ImgResponse> responseObserver) {
  ...
  public static final class SdServiceBlockingStub
    ...
    /**
     */
    public Sd.SdText2ImgResponse text2img(Sd.SdText2ImgRequest request) {
    ...
    /**
     */
    public Sd.SdImg2ImgResponse img2img(Sd.SdImg2ImgRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class SdServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<Sd.SdText2ImgResponse> text2img(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<Sd.SdImg2ImgResponse> img2img(
